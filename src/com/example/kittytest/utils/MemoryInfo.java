...
public class MemoryInfo {
	...
	private static final String LOG_TAG = "KittyTest-" + MemoryInfo.class.getSimpleName();
	...
	public int getPidMamorySize(int pid, Context baseContext) {
